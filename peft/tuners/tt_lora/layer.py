...
class Linear(nn.Module, TTLoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        TTLoraLayer.__init__(self, base_layer, **kwargs)
...
class Embedding(nn.Module, TTLoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        TTLoraLayer.__init__(self, base_layer)
...
class Conv2d(nn.Module, TTLoraLayer):
